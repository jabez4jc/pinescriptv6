# Types and type qualifiers (int, float, series, simple, array, map, chart.point, footprint, ...)
...
To learn more, see our User Manual's section on [type qualifiers](../language/type_system.md#qualifiers).
...
Explicitly mentioning the type in a variable declaration is optional, except when it is initialized with `na`. Learn more about Pine Script® types in the User Manual page on the [Type System](../language/type_system.md).
...
**See also:** `var`, `varip`, `float`, `bool`, `color`, `string`
...
**See also:** `var`, `varip`, `int`, `bool`, `color`, `string`
...
Explicitly mentioning the type in a variable declaration is optional. Learn more about Pine Script® types in the User Manual page on the [Type System](../language/type_system.md).
...
**See also:** `var`, `varip`, `int`, `float`, `color`, `string`, `true`, `false`
...
**See also:** `var`, `varip`, `int`, `float`, `bool`, `str.tostring()`, `str.format()`
...
**See also:** `var`, `varip`, `int`, `float`, `string`, `color.rgb()`, `color.new()`
...
**See also:** `var`, `label`, `box`, `line.new()`
...
**See also:** `var`, `line`, `box`, `label.new()`
...
**See also:** `var`, `line`, `label`, `table`, `box.new()`
...
**See also:** `var`, `line`, `label`, `box`, `table.new()`
...
**See also:** `var`, `line`, `label`, `table`, `box`, `linefill.new()`
...
**See also:** `var`, `line`, `label`, `table`, `box`, `array.new<type>()`, `array.from()`
...
**See also:** `var`, `matrix.new<type>()`, `array`
...
**See also:** `request.footprint()`, `volume_row`, `footprint.total_volume()`, `footprint.buy_volume()`, `footprint.sell_volume()`, `footprint.delta()`, `footprint.poc()`, `footprint.vah()`, `footprint.val()`, `footprint.rows()`, `footprint.get_row_by_price()`
...
**See also:** `footprint`, `volume_row.up_price()`, `volume_row.down_price()`, `volume_row.total_volume()`, `volume_row.buy_volume()`, `volume_row.sell_volume()`, `volume_row.delta()`, `volume_row.has_buy_imbalance()`, `volume_row.has_sell_imbalance()`
...
Map objects are always of [series](../language/type_system.md#series) form.
