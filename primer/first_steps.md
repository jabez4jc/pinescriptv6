...
Welcome to the Pine Script® [v6 User Manual](welcome.md), which will accompany you in your journey to learn to program your own trading tools in Pine Script. Welcome also to the very active community of Pine Script programmers on TradingView.
...
If you are already familiar with the use of Pine scripts on TradingView and are now ready to learn how to write your own, then jump to the [Writing scripts](#writing-scripts) section of this page.
...
The scripts feed generates *script widgets*, which show the title and author of each [publication](../writing_scripts/publishing.md#script-publications) with a preview of the published chart and description. Clicking on a widget opens the *script page*, which shows the publication’s complete description, an enlarged chart, and any additional release notes. Users can boost, favorite, share, and comment on publications. If it is an [open-source](../writing_scripts/publishing.md#open) script, the source code is also available on the script page.
...
- Many scripts by authors with high reputations and [open-source](../writing_scripts/publishing.md#open) publications
...
The next step we recommend is to write your [first indicator](first_indicator.md).
