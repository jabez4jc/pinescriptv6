...
- We use a [tuple](../language/variable_declarations.md#tuple-declarations) with `request.security()` to fetch four values with the same call.
- We use `plotcandle()` to plot our candles. See the [Bar plotting](../visuals/bar_plotting.md) page for more information.
